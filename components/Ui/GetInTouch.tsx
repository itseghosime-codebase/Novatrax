    ...
    return (
        <button
            ...
            <div className='relative z-10'>
                ...
                <svg className="drop-shadow-lg drop-shadow-[#CB6AFF]" width={188} height={25} viewBox={`0 0 212 28`} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='relative z-10 flex items-center justify-center'>
                <Image
                    ...
                    sizes="100%"
                />
                <p className="text-white font-mono text-2xl uppercase">get in touch</p>
                <Image
                    src={ArrowRight}
                    alt="Arrow Right"
