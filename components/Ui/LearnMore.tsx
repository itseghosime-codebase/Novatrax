...
export default function LearnMore() {
    ...
    return (
        <button
            ...
            className='flex flex-col items-center justify-center scale-75 md:scale-95 text-[#CB6AFF] group mt-5 -space-y-1 relative'>
            ...
            <div className='relative z-10'>
                ...
                <svg className="drop-shadow-lg drop-shadow-[#CB6AFF]" width={180} height={25} viewBox={`0 0 212 28`} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='relative z-10 flex items-center justify-center'>
                <Image
                    ...
                    sizes="100%"
                />
                <p className="text-white font-mono text-2xl uppercase">Learn more</p>
                <Image
                    src={ArrowRight}
                    alt="Arrow Right"
