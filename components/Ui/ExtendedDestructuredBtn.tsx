...
export default function ExtendedDestructuredBtn({ label, width, height }: { label: string, width?: number, height?: number }) {
    ...
    return (
        <button
            ...
            className='flex flex-col items-center justify-center scale-75 md:scale-95 text-[#CB6AFF] -space-y-1 group mt-5 relative'>
            ...
            <div className='relative z-10'>
                ...
                <svg className="drop-shadow-lg drop-shadow-[#CB6AFF]" width={width} height={height} viewBox={`0 0 212 28`} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='relative z-10 flex items-center justify-center gap-5'>
                <Image
                    ...
                    sizes="100%"
                />
                <p className="text-white font-mono text-2xl uppercase">{label}</p>
                <Image
                    src={ArrowRight}
                    alt="Arrow Right"
